...
const Solution1MilBoxSlider = dynamic(
  () => import("@/src/components/sliders/Solution1MilBoxSlider copy 4"),
  {
    ssr: false,
  }
);
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  Fortek sızdırmazlık hava damperleri, gazlara karşı %100
                  sızdırmazlık gerektiren durumlar için doğru çözümdür.
                </h5>
              </div>
            </div>
