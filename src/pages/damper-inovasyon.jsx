          ...
          <div className="row justify-content-between">
            <div className="col-lg-8 col-xl-8 mil-mb-120">
              ...
              <h3 className="mil-up-font mil-mb-30">
                Damper Sistemlerinde İnovasyon: Fortek'in Mühendislik Çözümleri
              </h3>
              ...
              <p className="mil-mb-30">
                Modern endüstriyel tesislerin karşı karşıya kaldığı en büyük
                zorluklardan biri, optimum verimlilik ve sürdürülebilirlik
                standartlarını korurken maliyetleri düşürmektir. Bu alanda,
                damper sistemleri kritik bir rol oynamaktadır ve Fortek
                Endüstriyel, bu konuda çığır açan yenilikler sunuyor.
              </p>
              <p className="mil-mb-60">
                Fortek, yılların tecrübesi ve derin mühendislik bilgisiyle,
                yüksek sıcaklıklar ve ağır endüstriyel uygulamalar için
                tasarlanmış damper sistemleri üretiyor. Bu sistemler, sadece
                güçlü ve dayanıklı değil, aynı zamanda enerji verimliliğini
                maksimize eden akıllı tasarımlara sahip. Özelleştirilmiş damper
                çözümlerimiz, yüksek ısı ve basınç altında bile sıfır
                sızdırmazlık sağlayarak, işletmelerin üretim süreçlerini
                iyileştiriyor ve operasyonel mükemmelliği destekliyor.
              </p>
