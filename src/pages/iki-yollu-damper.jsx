...
const Solution1 = () => {
  return (
    <Layouts footer={2}>
      <PageBanner
        pageName={"2 YOLLU DAMPERLER"}
        pageTitle={"2 YOLLU DAMPERLER"}
      />
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  İnşaat ve madencilik sektörlerindeki ağır yük taşımacılığında
                  devrim yaratan çift yönlü damperlerimiz, dayanıklılık ve
                  verimlilikte yeni standartlar belirliyor. İhtiyacınız olan
                  güvenilirlik ve performansı sunuyoruz.
                </h5>
              </div>
            </div>
