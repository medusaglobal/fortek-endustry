...
export async function getStaticPaths() {
  return {
    paths: [
      { params: { service: "damper-uretimi" } },
      {
        params: { service: "damper-sistemlerinin-modernizasyonu-ve-yonetimi" },
      },
      { params: { service: "proje-yonetimi-ve-tedarik" } },
    ],
    fallback: false,
  };
}
              ...
              <div className="mil-service-item mil-without-lines mil-mb-60">
                ...
                <div className="mil-service-text">
                  <h5 className="mil-mb-30">
                    ...
                    {Content.section_products.products7.title}
                  </h5>
                  <p>{Content.section_products.products7.description}</p>
                </div>
              </div>
            </div>
          </div>
