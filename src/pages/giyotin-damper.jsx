...
const Solution1About = dynamic(
  () => import("@/src/components/sliders/Solution1About copy 3"),
  {
    ssr: false,
  }
);
const Solution1MilBoxSlider = dynamic(
  () => import("@/src/components/sliders/Solution1MilBoxSlider copy 3"),
  {
    ssr: false,
  }
);
...
const Solution1 = () => {
  return (
    <Layouts footer={2}>
      <PageBanner
        pageName={"Giyotin Damperler"}
        pageTitle={"Giyotİn Damperler"}
      />
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  Fortek giyotin damperler, bakım ve arıza tespiti için esnek
                  kullanımlar sunar; her durumda mükemmel sızdırmazlık için
                  çeşitli sızdırmazlık sistemleriyle donatılmıştır.
                </h5>
              </div>
            </div>
