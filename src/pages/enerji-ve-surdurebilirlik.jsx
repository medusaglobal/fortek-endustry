          ...
          <div className="row justify-content-between">
            <div className="col-lg-8 col-xl-8 mil-mb-120">
              ...
              <p className="mil-mb-30">
                ...
                yöntemleri, günümüz endüstriyel işletmeleri için olmazsa olmaz
                hale gelmiştir. Fortek Endüstriyel, enerji verimliliği ve
                çevresel etkinliği artıran damper sistemleriyle bu alanda
                öncülük ediyor.
              </p>
              <p className="mil-mb-60">
                Bizim için her damper, bir enerji tasarrufu fırsatıdır. Fortek
                olarak, yenilenebilir enerji seçenekleri ve alternatif üretim
                teknolojilerini entegre eden damper tasarımları geliştiriyoruz.
                Böylece müşterilerimizin enerji maliyetlerini azaltmalarına ve
                karbon ayak izlerini düşürmelerine yardımcı oluyoruz. Bu, sadece
                finansal tasarruflar sağlamakla kalmaz, aynı zamanda gelecek
                nesiller için daha yaşanabilir bir dünya bırakmamıza da olanak
                tanır.
              </p>
