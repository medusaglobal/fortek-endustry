...
const Solution1About = dynamic(
  () => import("@/src/components/sliders/Solution1About copy"),
  {
    ssr: false,
  }
);
const Solution1MilBoxSlider = dynamic(
  () => import("@/src/components/sliders/Solution1MilBoxSlider copy"),
  {
    ssr: false,
  }
);
...
const Solution1 = () => {
  return (
    <Layouts footer={2}>
      <PageBanner
        pageName={"3 YOLLU DAMPERLER"}
        pageTitle={"3 YOLLU DAMPERLER"}
      />
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  3 yollu damperler, ana proses ile bypass arasındaki gaz
                  akışını yönlendirmek için kullanılır. Bu damperler izolasyon
                  veya kontrol amaçlı olabilir.
                </h5>
              </div>
            </div>
