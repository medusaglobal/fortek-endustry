...
const Solution1MilBoxSlider = dynamic(
  () => import("@/src/components/sliders/Solution1MilBoxSlider copy 2"),
  {
    ssr: false,
  }
);
...
const Solution1 = () => {
  return (
    <Layouts footer={2}>
      <PageBanner
        pageName={"Çok Kanatlı Damperler (Multilouver)"}
        pageTitle={"Çok Kanatlı Damperler (Multilouver)"}
      />
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  Fortek çok kanatlı damperler, üst düzey kontrol için idealdir;
                  paralel ve karşılıklı hareket eden kanatlarla tam izolasyon ve
                  akış yönetimi sağlar.
                </h5>
              </div>
            </div>
